							...
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return function (l) {
												return {epoch: a, epochValidation: b, learningRate: c, learningRateValidation: d, somSizeRow: e, somSizeRowValidation: f, somSizeCol: g, somSizeColValidation: h, regions: i, showModal: j, modalRegion: k, isConfigInputValid: l};
											};
										};
									};
								};
...
var _user$project$Model$Region = F7(
	function (a, b, c, d, e, f, g) {
		return {label: a, labelValidation: b, topLeft: c, topRight: d, bottomLeft: e, bottomRight: f, isModalInputValid: g};
	});
...
var _user$project$Model$SomSizeColInput = function (a) {
	return {ctor: 'SomSizeColInput', _0: a};
};
var _user$project$Model$SomSizeRowInput = function (a) {
	return {ctor: 'SomSizeRowInput', _0: a};
};
var _user$project$Model$LearningRateInput = function (a) {
	return {ctor: 'LearningRateInput', _0: a};
};
var _user$project$Model$EpochInput = function (a) {
...
var _user$project$Model$defaultRegion = {label: '', labelValidation: _user$project$Model$Empty, topLeft: _user$project$Model$defaultPoint, topRight: _user$project$Model$defaultPoint, bottomLeft: _user$project$Model$defaultPoint, bottomRight: _user$project$Model$defaultPoint, isModalInputValid: false};
...
var _user$project$Helper$getUiValidation = F2(
	function (validationState, invalidMsg) {
		var _p0 = validationState;
		switch (_p0.ctor) {
			case 'Valid':
			...
			default:
				return {ctor: '_Tuple2', _0: ' is-invalid ', _1: invalidMsg};
		}
	});
...
var _user$project$Ports$fileSelectedPort = _elm_lang$core$Native_Platform.outgoingPort(
	'fileSelectedPort',
	function (v) {
		return null;
	});

var _user$project$Update$validatePoint = F3(
	function (point, row, col) {
		var updatedYValidation = _elm_lang$core$String$isEmpty(point.y) ? _user$project$Model$Empty : (A2(
			_user$project$Helper$isValidPointCoordinate,
			_user$project$Helper$toInt(point.y),
			_user$project$Helper$toInt(col)) ? _user$project$Model$Valid : _user$project$Model$Invalid);
		var updatedXValidation = _elm_lang$core$String$isEmpty(point.x) ? _user$project$Model$Empty : (A2(
			_user$project$Helper$isValidPointCoordinate,
			_user$project$Helper$toInt(point.x),
			_user$project$Helper$toInt(row)) ? _user$project$Model$Valid : _user$project$Model$Invalid);
...
var _user$project$Update$validateModalRegion = F2(
	function (_p0, region) {
		...
		return _elm_lang$core$Native_Utils.update(
			region,
			{labelValidation: updatedLabelValidation, topLeft: updatedTopLeft, topRight: updatedTopRight, bottomLeft: updatedBottomLeft, bottomRight: updatedBottomRight, isModalInputValid: updatedModalStatus});
	});
var _user$project$Update$validate = function (model) {
	...
	return _elm_lang$core$Native_Utils.update(
		model,
		{epochValidation: updatedEpochValidation, learningRateValidation: updatedLearningRateValidation, somSizeRowValidation: updatedSomSizeRowValidation, somSizeColValidation: updatedSomSizeColValidation, isConfigInputValid: updatedConfigStatus});
};
		...
		switch (_p4.ctor) {
			...
			case 'ShowAddRegionModal':
				...
				return {
					...
					_1: A2(
						...
						_elm_lang$core$Basics$always(_user$project$Model$NoOp),
						_elm_lang$dom$Dom$focus('addRegionModal'))
				};
			case 'HideAddRegionModal':
				var updatedModel = _elm_lang$core$Native_Utils.update(
					model,
					{showModal: false});
			...
			default:
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Ports$fileSelectedPort(
						{ctor: '_Tuple0'})
				};
		}
	});

var _user$project$View_AddRegionModal$validationState = function (point) {
	return {
		ctor: '_Tuple2',
		_0: A2(_user$project$Helper$getUiValidation, point.xValidation, 'Invalid x-coordinate'),
		_1: A2(_user$project$Helper$getUiValidation, point.yValidation, 'Invalid y-coordinate')
	};
};
var _user$project$View_AddRegionModal$viewAddRegionModal = function (_p0) {
	var _p1 = _p0;
	var _p8 = _p1.modalRegion;
	var _p2 = _user$project$View_AddRegionModal$validationState(_p8.bottomRight);
	var bRxCss = _p2._0._0;
	var bRxMsg = _p2._0._1;
	var bRyCss = _p2._1._0;
	var bRyMsg = _p2._1._1;
	var _p3 = _user$project$View_AddRegionModal$validationState(_p8.bottomLeft);
	var bLxCss = _p3._0._0;
	var bLxMsg = _p3._0._1;
	var bLyCss = _p3._1._0;
	var bLyMsg = _p3._1._1;
	var _p4 = _user$project$View_AddRegionModal$validationState(_p8.topRight);
	var tRxCss = _p4._0._0;
	var tRxMsg = _p4._0._1;
	var tRyCss = _p4._1._0;
	var tRyMsg = _p4._1._1;
	var _p5 = _user$project$View_AddRegionModal$validationState(_p8.topLeft);
	var tLxCss = _p5._0._0;
	var tLxMsg = _p5._0._1;
	var tLyCss = _p5._1._0;
	var tLyMsg = _p5._1._1;
	var _p6 = A2(_user$project$Helper$getUiValidation, _p8.labelValidation, 'Region label already exists');
	var labelCss = _p6._0;
	var labelMsg = _p6._1;
	var _p7 = _p1.showModal;
	if (_p7 === true) {
		return A2(
															...
															},
															{
																	...
																	_elm_lang$html$Html$input,
																	{
																		...
																		_1: {
																			...
																			_0: _elm_lang$html$Html_Attributes$class(
																				A2(_elm_lang$core$Basics_ops['++'], 'form-control form-control-sm', labelCss)),
																			_1: {
																				ctor: '::',
																				_0: _elm_lang$html$Html_Attributes$id('addRegionModal'),
																				_1: {
																					ctor: '::',
																					...
																					_1: {
																						...
																						_1: {
																							...
																							_1: {
																								ctor: '::',
																								_0: _elm_lang$html$Html_Attributes$value(_p8.label),
																								_1: {ctor: '[]'}
																							}
																						}
																					}
																...
																_1: {
																	...
																	_0: A2(
																		...
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html$text(labelMsg),
																			_1: {ctor: '[]'}
																		}),
																	_1: {ctor: '[]'}
																}
																	...
																	},
																	{
																			...
																			_elm_lang$html$Html$input,
																			{
																				...
																				_1: {
																					...
																					_1: {
																						ctor: '::',
																						_0: _elm_lang$html$Html_Attributes$class(
																							A2(_elm_lang$core$Basics_ops['++'], 'form-control form-control-sm', tLxCss)),
																						_1: {
																							ctor: '::',
																							...
																							_1: {
																								...
																								_1: {
																									...
																									_1: {
																										ctor: '::',
																										_0: _elm_lang$html$Html_Attributes$value(_p8.topLeft.x),
																										_1: {ctor: '[]'}
																									}
																								}
																							}
																		...
																		_1: {
																			...
																			_0: A2(
																				...
																				{
																					ctor: '::',
																					_0: _elm_lang$html$Html$text(tLxMsg),
																					_1: {ctor: '[]'}
																				}),
																			_1: {ctor: '[]'}
																		}
																			...
																			},
																			{
																					...
																					_elm_lang$html$Html$input,
																					{
																						...
																						_1: {
																							...
																							_1: {
																								ctor: '::',
																								_0: _elm_lang$html$Html_Attributes$class(
																									A2(_elm_lang$core$Basics_ops['++'], 'form-control form-control-sm', tLyCss)),
																								_1: {
																									ctor: '::',
																									...
																									_1: {
																										...
																										_1: {
																											...
																											_1: {
																												ctor: '::',
																												_0: _elm_lang$html$Html_Attributes$value(_p8.topLeft.y),
																												_1: {ctor: '[]'}
																											}
																										}
																									}
																				...
																				_1: {
																					...
																					_0: A2(
																						...
																						{
																							ctor: '::',
																							_0: _elm_lang$html$Html$text(tLyMsg),
																							_1: {ctor: '[]'}
																						}),
																					_1: {ctor: '[]'}
																				}
																		...
																		},
																		{
																				...
																				_elm_lang$html$Html$input,
																				{
																					...
																					_1: {
																						...
																						_1: {
																							ctor: '::',
																							_0: _elm_lang$html$Html_Attributes$class(
																								A2(_elm_lang$core$Basics_ops['++'], 'form-control form-control-sm', tRxCss)),
																							_1: {
																								ctor: '::',
																								...
																								_1: {
																									...
																									_1: {
																										...
																										_1: {
																											ctor: '::',
																											_0: _elm_lang$html$Html_Attributes$value(_p8.topRight.x),
																											_1: {ctor: '[]'}
																										}
																									}
																								}
																			...
																			_1: {
																				...
																				_0: A2(
																					...
																					{
																						ctor: '::',
																						_0: _elm_lang$html$Html$text(tRxMsg),
																						_1: {ctor: '[]'}
																					}),
																				_1: {ctor: '[]'}
																			}
																				...
																				},
																				{
																						...
																						_elm_lang$html$Html$input,
																						{
																							...
																							_1: {
																								...
																								_1: {
																									ctor: '::',
																									_0: _elm_lang$html$Html_Attributes$class(
																										A2(_elm_lang$core$Basics_ops['++'], 'form-control form-control-sm', tRyCss)),
																									_1: {
																										ctor: '::',
																										...
																										_1: {
																											...
																											_1: {
																												...
																												_1: {
																													ctor: '::',
																													_0: _elm_lang$html$Html_Attributes$value(_p8.topRight.y),
																													_1: {ctor: '[]'}
																												}
																											}
																										}
																					...
																					_1: {
																						...
																						_0: A2(
																							...
																							{
																								ctor: '::',
																								_0: _elm_lang$html$Html$text(tRyMsg),
																								_1: {ctor: '[]'}
																							}),
																						_1: {ctor: '[]'}
																					}
																			...
																			},
																			{
																					...
																					_elm_lang$html$Html$input,
																					{
																						...
																						_1: {
																							...
																							_1: {
																								ctor: '::',
																								_0: _elm_lang$html$Html_Attributes$class(
																									A2(_elm_lang$core$Basics_ops['++'], 'form-control form-control-sm', bLxCss)),
																								_1: {
																									ctor: '::',
																									...
																									_1: {
																										...
																										_1: {
																											...
																											_1: {
																												ctor: '::',
																												_0: _elm_lang$html$Html_Attributes$value(_p8.bottomLeft.x),
																												_1: {ctor: '[]'}
																											}
																										}
																									}
																				...
																				_1: {
																					...
																					_0: A2(
																						...
																						{
																							ctor: '::',
																							_0: _elm_lang$html$Html$text(bLxMsg),
																							_1: {ctor: '[]'}
																						}),
																					_1: {ctor: '[]'}
																				}
																					...
																					},
																					{
																							...
																							_elm_lang$html$Html$input,
																							{
																								...
																								_1: {
																									...
																									_1: {
																										ctor: '::',
																										_0: _elm_lang$html$Html_Attributes$class(
																											A2(_elm_lang$core$Basics_ops['++'], 'form-control form-control-sm', bLyCss)),
																										_1: {
																											ctor: '::',
																											...
																											_1: {
																												...
																												_1: {
																													...
																													_1: {
																														ctor: '::',
																														_0: _elm_lang$html$Html_Attributes$value(_p8.bottomLeft.y),
																														_1: {ctor: '[]'}
																													}
																												}
																											}
																						...
																						_1: {
																							...
																							_0: A2(
																								...
																								{
																									ctor: '::',
																									_0: _elm_lang$html$Html$text(bLyMsg),
																									_1: {ctor: '[]'}
																								}),
																							_1: {ctor: '[]'}
																						}
																				...
																				},
																				{
																						...
																						_elm_lang$html$Html$input,
																						{
																							...
																							_1: {
																								...
																								_1: {
																									ctor: '::',
																									_0: _elm_lang$html$Html_Attributes$class(
																										A2(_elm_lang$core$Basics_ops['++'], 'form-control form-control-sm', bRxCss)),
																									_1: {
																										ctor: '::',
																										...
																										_1: {
																											...
																											_1: {
																												...
																												_1: {
																													ctor: '::',
																													_0: _elm_lang$html$Html_Attributes$value(_p8.bottomRight.x),
																													_1: {ctor: '[]'}
																												}
																											}
																										}
																					...
																					_1: {
																						...
																						_0: A2(
																							...
																							{
																								ctor: '::',
																								_0: _elm_lang$html$Html$text(bRxMsg),
																								_1: {ctor: '[]'}
																							}),
																						_1: {ctor: '[]'}
																					}
																						...
																						},
																						{
																								...
																								_elm_lang$html$Html$input,
																								{
																									...
																									_1: {
																										...
																										_1: {
																											ctor: '::',
																											_0: _elm_lang$html$Html_Attributes$class(
																												A2(_elm_lang$core$Basics_ops['++'], 'form-control form-control-sm', bRyCss)),
																											_1: {
																												ctor: '::',
																												...
																												_1: {
																													...
																													_1: {
																														...
																														_1: {
																															ctor: '::',
																															_0: _elm_lang$html$Html_Attributes$value(_p8.bottomRight.y),
																															_1: {ctor: '[]'}
																														}
																													}
																												}
																							...
																							_1: {
																								...
																								_0: A2(
																									...
																									{
																										ctor: '::',
																										_0: _elm_lang$html$Html$text(bRyMsg),
																										_1: {ctor: '[]'}
																									}),
																								_1: {ctor: '[]'}
																							}
										...
										_1: {
											...
											_0: A2(
												_elm_lang$html$Html$button,
												{
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$disabled(!_p8.isModalInputValid),
														_1: {
															ctor: '::',
...
var _user$project$View_ConfigPanel$textPoint = function (point) {
	return A2(
		...
		A2(
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				',',
				A2(_elm_lang$core$Basics_ops['++'], point.y, ')'))));
};
var _user$project$View_ConfigPanel$viewRegion = function (region) {
	var textRegion = A2(
		...
		A2(
			_elm_lang$core$Basics_ops['++'],
			_user$project$View_ConfigPanel$textPoint(region.topLeft),
			A2(
				_elm_lang$core$Basics_ops['++'],
				'; tR: ',
				A2(
					_elm_lang$core$Basics_ops['++'],
					_user$project$View_ConfigPanel$textPoint(region.topRight),
					A2(
						_elm_lang$core$Basics_ops['++'],
						'; bL: ',
						A2(
							_elm_lang$core$Basics_ops['++'],
							_user$project$View_ConfigPanel$textPoint(region.bottomLeft),
							A2(
								_elm_lang$core$Basics_ops['++'],
								'; bR: ',
								_user$project$View_ConfigPanel$textPoint(region.bottomRight))))))));
	return A2(
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(region.label),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html$text(textRegion),
						_1: {ctor: '[]'}
					}
				}),
			_1: {ctor: '[]'}
...
var _user$project$View_ConfigPanel$viewConfigPanel = function (model) {
	var _p0 = A2(_user$project$Helper$getUiValidation, model.somSizeColValidation, 'Invalid column size');
	var somSizeColCss = _p0._0;
	var somSizeColMsg = _p0._1;
	var _p1 = A2(_user$project$Helper$getUiValidation, model.somSizeRowValidation, 'Invalid row size');
	var somSizeRowCss = _p1._0;
	var somSizeRowMsg = _p1._1;
	var _p2 = A2(_user$project$Helper$getUiValidation, model.learningRateValidation, 'Invalid learning rate');
	var learningRateCss = _p2._0;
	var learningRateMsg = _p2._1;
	var _p3 = A2(_user$project$Helper$getUiValidation, model.epochValidation, 'Invalid epoch');
	var epochCss = _p3._0;
	var epochMsg = _p3._1;
	return A2(
		_elm_lang$html$Html$div,
								...
								_0: A2(
									...
									},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('form-group col'),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text('Epoch'),
														_1: {ctor: '[]'}
													}),
												_1: {
													ctor: '::',
											...
											_0: A2(
												...
												},
												{
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text('Learning Rate'),
															_1: {ctor: '[]'}
														}),
													_1: {
														ctor: '::',
											...
											_0: A2(
												...
												},
												{
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text('SOM Size'),
															_1: {ctor: '[]'}
														}),
													_1: {ctor: '[]'}
												}),
														...
														_0: A2(
															...
															},
															{
																...
																_0: A2(
																	...
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html$text('Regions'),
																		_1: {ctor: '[]'}
																	}),
																_1: {
																	ctor: '::',
																	_0: A2(
																		_elm_lang$html$Html$button,
																		{
																			...
																			_1: {
																				...
																				_1: {
																					ctor: '::',
																					_0: _elm_lang$html$Html_Events$onClick(_user$project$Model$ShowAddRegionModal),
																					_1: {ctor: '[]'}
																				}
																			}
																		},
										...
										_1: {
											...
											_0: A2(
												_elm_lang$html$Html$button,
												{
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$disabled(!model.isConfigInputValid),
														_1: {ctor: '[]'}
													}
												},
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Train'),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}
...
var _user$project$View$viewSomVisualizationPanel = A2(
	_elm_lang$html$Html$div,
	{ctor: '[]'},
	{
		ctor: '::',
...
var _user$project$View$viewDatasetPanel = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('row'),
				...
				},
				{
					...
					_0: A2(
						...
						},
						{
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _user$project$View$viewDatasetPanel,
									_1: {ctor: '[]'}
								}
							}
						}),
					_1: {
						...
						_0: A2(
							_elm_lang$html$Html$div,
							{
								...
								_1: {
									...
									_0: _elm_lang$html$Html_Attributes$style(
										{
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'border-left', _1: 'thin solid #888888'},
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
							...
							{
								ctor: '::',
								_0: _user$project$View$viewSomVisualizationPanel,
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
